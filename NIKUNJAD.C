...
//if polynomial empty. make the node the head node
	 ...
	 {
	 //else go the last node and apend
	 temp=head;
	...
	//if exponent of current node of polynomial 2 is greater than than of polynomial
	//add it to the sum
	...
	//if exponent of current node polynomial is 1 is equal to that of polynomial 2
	...
	//to store the polynomial 2 and the sum
